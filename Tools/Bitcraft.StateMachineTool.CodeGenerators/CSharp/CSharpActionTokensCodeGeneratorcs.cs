...
namespace Bitcraft.StateMachineTool.CodeGenerators.CSharp
{
    public class CSharpActionTokensCodeGenerator : CodeGeneratorBase
    {
        ...
        public CSharpActionTokensCodeGenerator(ILanguageAbstraction languageAbstraction, string namespaceName, string stateMachineName, bool isInternal, IGraph graph)
