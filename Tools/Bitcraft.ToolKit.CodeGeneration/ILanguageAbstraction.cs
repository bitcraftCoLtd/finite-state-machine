...
namespace Bitcraft.ToolKit.CodeGeneration
{
    public interface ILanguageAbstraction
    {
        ...
        ConstructorDeclarationCodeGenerator CreateConstructorDeclarationCodeGenerator(AccessModifier accessModifier, bool isStatic, string name, ArgumentInfo[] arguments, ParentConstructorType parentConstructorType, string[] parentConstructorParameters, ScopeCodeGenerator bodyGenerator);
        ...
        ScopeCodeGenerator CreateScopeCodeGenerator(ICodeGenerator innerGenerator, bool closeWithNewLine);
